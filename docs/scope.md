...
Borrower decisions, investment recommendations, valuation, trading, hedging, and causal claims are excluded. Price, yield, OAS, spreads, duration, convexity, WAL, returns, MSR, macro sensitivity, and loss severity require separately approved sources and models.
