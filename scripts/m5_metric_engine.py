...
def main() -> int:
    ...
    parser.add_argument("--security-contract", type=Path, default=Path(".project/m4-source-contract.json"))
    parser.add_argument("--loan-contract", type=Path, default=Path(".project/m4-loan-source-contract.json"))
